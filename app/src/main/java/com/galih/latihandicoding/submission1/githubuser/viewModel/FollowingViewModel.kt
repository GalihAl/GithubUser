...
class FollowingViewModel  : ViewModel() {
    private val listFollowerNonMutable = ArrayList<UserFollowing>()
    private val listFollowerMutable = MutableLiveData<ArrayList<UserFollowing>>()
