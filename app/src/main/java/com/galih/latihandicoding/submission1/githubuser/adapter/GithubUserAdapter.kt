...
class GithubUserAdapter(private var listGithubUser: ArrayList<GithubUser>) :
    ...
    override fun onBindViewHolder(holder: ListViewHolder, position: Int) {
        ...
        holder.itemView.setOnClickListener { onItemClickCallback.onItemClicked(listGithubUser[position]) }
